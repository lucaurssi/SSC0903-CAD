...
// mpirun -np 8 --host hostname1:slots,hostname2:slots hellofor (segue -host e segue limitacoes. slots � opcional (default 1))
// mpirun -np 12 --host hal02:4,hal03:4,hal05:4,hal07:4 hellofor
...
int  main(int argc, char *argv[])  {
	...
	if ( myrank == 0) {
		...
		// ha um processo executando aqui
        printf("There are %d processes. This is master (0)\n", npes);
		...
		// ha npes-1 processos executando aqui
